...
export async function queryLogList(params) {
  return request('/HiatmpPro/bsp/alarmquery/queryLogList', {
    method: 'POST',
...
export async function logExportRecord(params) {
  return request('/HiatmpPro/bsp/alarmquery/logExportRecord', {
    method: 'POST',
    body: JSON.stringify(params),
  });
}
...
export async function logDetailRecord(params) {
  return request('/HiatmpPro/bsp/alarmquery/logDetail', {
    method: 'POST',
    body: JSON.stringify(params),
  });
}
