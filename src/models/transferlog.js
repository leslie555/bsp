...
import { queryLogList, exportLogList, logExportRecord, getFirstMenuList, logDetailRecord } from '../services/transferlog';

export default {
  namespace: 'transferlog',
  state: {
    loglist: [],
    loginfo: {},
    menus: [],
  ...
  subscriptions: {
    setup({ dispatch, history }) {
      history.listen((location) => {
        if (location.pathname === '/transferlog') {
          dispatch({
