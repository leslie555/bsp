...
import Search from '../../components/oct/BlackListSearch';
import List from '../../components/oct/BlackListList';
...
class BlackList extends React.Component {
  ...
  render() {
    const { octBlackList, common, dispatch } = this.props;
    const {
      queryobj,
      pagination,
      resultlist,
...
function mapStateToProps({ octBlackList, common }) {
  return { octBlackList, common };
}
