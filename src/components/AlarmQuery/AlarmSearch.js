            ...
            <Row>
              <Col span={8}>
                <FormItem {...formItemLayout} label="设备编号">
                  {getFieldDecorator('deviceid', { initialValue: '' })(<Input maxLength="30" />)}
                </FormItem>
              </Col>
              <Col span={8}>
            ...
            <Row>
              <Col span={8}>
                <FormItem {...formItemLayout} label="报警类型">
                  {getFieldDecorator('alarmtype', { initialValue: '-1' })(<Select>{this.handleGenEnumOption(ALARMTYPE)}</Select>)}
                </FormItem>
              </Col>
              <Col span={8}>
...
export default Form.create()(AlarmSearch);
