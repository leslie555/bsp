...
import { updatePwdForOperator } from '../../services/accmservice';
          ...
          <Row gutter={20}>
            <FormItem {...formItemLayout} label="新密码">
              {getFieldDecorator('cuserpwdnew', {
                ...
                rules: [{
                  required: true,
                  message: pwdComplexity === '1' ? '密码必须是包含大小写字母、数字、特殊字符至少两种组合在内的8~16个字符!' : '请输入中文除外的1-16位密码',
                  pattern: pwdComplexity === '1' ? new RegExp(
