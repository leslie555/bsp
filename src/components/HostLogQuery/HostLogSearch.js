...
class HostLogSearch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    };
            ...
            <Row>
              ...
              <Col span={6}>
                <FormItem {...formItemLayout} label="事件描述">
                  {getFieldDecorator('eventdesc', { initialValue: '' })(<Input maxLength="200" />)}
                </FormItem>
              </Col>
              <Col span={6}>
...
export default Form.create()(HostLogSearch);
