...
class TransferLogSearch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    };
  ...
  render() {
    ...
    const noMatch = '';
    const startTime = moment(`${moment().subtract('days', 7).format('YYYY-MM-DD')} 00:00:00`, YEARANDTIME);
...
export default Form.create()(TransferLogSearch);
