...
const { Option } = Select;
class DeviceEventShieldSearch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    };
...
DeviceEventShieldSearch.prototypes = {
...
export default Form.create()(DeviceEventShieldSearch);
