...
const { Option } = Select;
class DeviceFunctionConfigSearch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    };
...
DeviceFunctionConfigSearch.prototypes = {
...
export default Form.create()(DeviceFunctionConfigSearch);
