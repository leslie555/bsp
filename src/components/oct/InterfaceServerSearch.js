...
const { Option } = Select;
class InterfaceServerSearch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    };
    ...
    return (
      <div className="outline-out outline-out-top">
        <div className="outline-inner">
          <h3 {...h3Layout}>接口服务管理</h3>
          <Form className="form-outline-inner-padding">
            <Row>
              <Col span={5}>
                <FormItem {...formItemLayout} label="接口编码">
...
InterfaceServerSearch.prototypes = {
...
export default Form.create()(InterfaceServerSearch);
