...
class Historylist extends React.Component {
  ...
  render() {
    const { codeList, loading, enumList, imglist, getImageList, columns, showV } = this.props;
          ...
          <div className="outline-inner-padding">
            <Row>
              ...
              <Col span={8} style={{ textAlign: 'right' }}>
                {showV ? (<Button type="primary" style={{ margin: '0 5px' }} disabled={(resultlist == null)} onClick={onDownload}><i className="table-right icon iconfont icon-export" />批量导出</Button>) : null}
              </Col>
            </Row>
          </div>
          <Table
