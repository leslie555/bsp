...
class AreaDetailtree extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      expandedKeys: ['0'], // 展开节点
  ...
  render() {
    const { menuList, onNodeSelect, onNodeClick } = this.props;
...
AreaDetailtree.propTypes = {
  menuList: PropTypes.array,
};
AreaDetailtree.defaultProps = {
  expandedKeys: ['0'],
  menuList: [],
};
export default AreaDetailtree;
