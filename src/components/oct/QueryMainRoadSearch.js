...
class QueryMainRoadSearch extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
    };
...
QueryMainRoadSearch.prototypes = {
...
export default Form.create()(QueryMainRoadSearch);
